...
if __name__=='__main__':
    ...
    parser.add_argument('--env_name',         type=str, default = 'BoxingNoFrameskip-v4', help='environment ID')
    ...
    logdir = 'atari/' + env_name + '/' + exp_name + '/' + 'seed' + '_' + str(seed) + '_' + time.strftime("%d-%m-%Y_%H-%M-%S")
